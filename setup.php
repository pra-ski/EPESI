...
if(!isset($_GET['license'])) {
	...
	$form -> addElement('html', '<tr><td colspan=2><h3>'.__('By installing and using this software you automatically accept terms<BR>of the EULA and also agree that:').'</h3></td></tr>');
